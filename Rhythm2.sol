...
contract Ownable is Initializable, Context {
    ...
    address private _previousStakingWalletAddress;
    ...
    event StakingWalletTransferred(address indexed previousStakingWalletAddress, address indexed newStakingWalletAddress);
    ...
    function setStakingWalletAddress(address newStakingWalletAddress) public virtual onlyOwner() {
        require(newStakingWalletAddress != _stakingWalletAddress, "Ownable: new staking wallet address is the current staking wallet address");
        emit StakingWalletTransferred(_stakingWalletAddress, newStakingWalletAddress);
        _stakingWalletAddress = newStakingWalletAddress;
    }
}

contract Rhythm is Initializable, Context, BEP20, Ownable, ReentrancyGuard {
    ...
    address public pancakeSellRouter;
    ...
    function initialize() public payable initializer {
        ...
        pancakeSellRouter = 0x0AaE7d35dfb0847C90ec4476552A7Da4Ce6a1A52;
    ...
    */
    ...
    function setPancakeRouter(address account) public onlyOwner() {
        pancakeswapRouter = account;
    }
    ...
    function _transfer(address from, address to, uint256 amount) nonReentrant private preventBlacklisted(_msgSender(), "Rhythm: Address is blacklisted") preventBlacklisted(from, "Rhythm: From address is blacklisted") preventBlacklisted(to, "Rhythm: To address is blacklisted") {
        ...
        if (!_isExcludedFromFee[from] && isSellLockEnabled()) {
            ...
            require(blockTimestamp < userInfo.lockExpiry && newTokensSoldInDay <= _maxSellAmountPerDay, "Rhythm: Sell exceeds daily limit.");
