...
public class UpdateFollowState {

	public static void send(String friendUsername, CompleteEvent event) {
		Post post = new Post();
		post.setDetails();
		post.setPacketType(PacketType.UPDATE_FOLLOW_STATE);

		JSONObject object = new JSONObject();
		object.put("friend", JSONValue.escape(friendUsername));
